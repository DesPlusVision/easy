...
<div id="pageEmpresa">
    <input type="button" data-element="#novaEmpresa" id="btCadastrarEmpresa" name="novo" value="Cadastrar Empresa" class="ui-button ui-widget ui-state-default ui-corner-all" role="button" aria-disabled="false" style="margin: 10px 0px;">
